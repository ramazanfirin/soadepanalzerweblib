 ...
 * 
 */
public final class CreateEntity extends Activity {
	 ...
	 * @param variable
	 */
	public CreateEntity(String name, String variable, String skipCondition) {
		super(name);
	...
	public final Image getImage() {
		return ImageFactory.ORACLE_11G_CREATE_ENTRY;
	}
