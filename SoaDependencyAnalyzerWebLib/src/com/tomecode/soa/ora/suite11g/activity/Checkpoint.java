 ...
 * 
 */
public final class Checkpoint extends Activity {
	 ...
	 * @param name
	 */
	public Checkpoint(String name, String skipCondition) {
		super(name);
	...
	public final Image getImage() {
		return ImageFactory.ORACLE_11G_CHECKPOINT;
	}
