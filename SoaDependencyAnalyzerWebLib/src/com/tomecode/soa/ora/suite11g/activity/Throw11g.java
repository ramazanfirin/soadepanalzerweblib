 ...
 * 
 * throw activity in SOA Suite 11g
 * 
 * @author Tomas Frastia
 * @see http://www.tomecode.com
 *      http://code.google.com/p/bpel-esb-dependency-analyzer/
 */
public final class Throw11g extends Throw {
	 ...
	 * @param skipCondition
	 */
	public Throw11g(String name, String faultVariable, String documentation, String skipCondition) {
		super(name, faultVariable, documentation);
